...
class Ui_MainWindow(QObject):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("pics/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem = QtWidgets.QSpacerItem(261, 31, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(261, 31, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
